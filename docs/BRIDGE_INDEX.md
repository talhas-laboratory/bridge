...
- Generated at: `2026-08-04T13:00:53.646581+00:00`
- Package version: `0.1.0`
- Known extensions: `packet`
...
| `docs:AGENTS` | `docs/agent-guidance` | Agent working rules for modular bridge development | `reasoning_bridge.extensions` | `b863190710ef` docs: add AGENTS.md modularity rules for bridge work |
